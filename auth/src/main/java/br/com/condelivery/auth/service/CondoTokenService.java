...
@Service
public class CondoTokenService {
    ...
    private static final long TOKEN_EXPIRATION_TIME = 2 * 60 * 60 * 1000;

    public String generateToken(Condominium condo) {
        try {
            ...
            String token = JWT.create()
                    .withIssuer(ISSUER)
                    .withSubject(condo.getEmail())
                    .withClaim("name", condo.getName())
                    .withClaim("condominiumId", condo.getId().toString())
